defmodule Timezone do
  ...
  ## Example
      ...
      {:ok, "Asia/Bangkok"}
  """
  @spec lookup(number | String.t() | Decimal.t(), number | String.t() | Decimal.t()) ::
  ...
  def lookup(lat, lng),
    do: {:error, "Unkownen latitude or longtitude error #{inspect(lat)} #{inspect(lng)}"}
